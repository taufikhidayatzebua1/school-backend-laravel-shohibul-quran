...
class UpdateOrangTuaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'username' => ['sometimes', 'string', 'max:255', Rule::unique('users', 'username')->ignore($this->orang_tua?->user_id)],
            'email' => ['sometimes', 'email', 'max:255', Rule::unique('users', 'email')->ignore($this->orang_tua?->user_id)],
